...
{ 
	...
	{
		requestTapjoyConnect(context, appID, secretKey, TapjoyConnectFlag.NONE);
	}
	 ...
	 * and before any other TapjoyConnect methods.
	 * <br>
	 * For special flags, supported values are:<br>
	 * {@link TapjoyConnectFlag#NONE}<br>
	 * {@link TapjoyConnectFlag#SHA2_UDID}
	 * @param context						The application context.
	 * @param appID							Your Tapjoy APP ID.
	 * @param secretKey						Your Tapjoy SECRET KEY.
	 * @param flags							Special flags.
	 */
	public static void requestTapjoyConnect(Context context, String appID, String secretKey, int flags)
	{
	 ...
	 * @param flags							Special flags.
	 */
	private TapjoyConnect(Context context, String appID, String secretKey, int flags)
	{
