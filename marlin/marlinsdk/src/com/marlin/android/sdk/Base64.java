...
public class Base64 {
	 ...
	 * 
	 * @param data
	 *            the array of base64-encoded characters, no whitespace allowed.
	 * @return decoded data array
	 * @throws Base64Exception
	 *             if the array-size was miscalculated, perhaps due to invalid
	 *             characters read on input.
	 */
	public byte[] decode(char[] data) throws Exception {
